    ...
    return (
      <div className="min-h-screen bg-brandYellow flex items-center justify-center px-4 relative">
        <div className="bg-white rounded-lg shadow-xl md:p-12 w-full max-w-md z-10">
          ...
          <h2 className="text-center text-xl font-semibold p-2 text-gray-800">
            Dukaan Se Admin
          </h2>
          <p className="text-center text-[13px] text-gray-600 mb-6 font-bold">
            Please Log In To Your Account
          </p>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="text-sm text-gray-700">Enter Your Email</label>
              <input
                type="email"
