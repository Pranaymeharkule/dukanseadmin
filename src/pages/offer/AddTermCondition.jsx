    ...
    <div className="bg-gray-100 min-h-screen flex flex-col font-sans p-4 relative">
      ...
      {success && (
        <div className="fixed inset-0 flex items-center justify-center bg-opacity-40 z-50">
          <div className="bg-white rounded-xl  p-8 flex flex-col items-center animate-fadeIn">
        ...
        <div className="bg-white rounded-xl overflow-hidden">
          <header className="flex items-center justify-between p-1 gap-3 bg-white">
            <div className="flex items-center bg-white px-4 py-3 rounded-md ">
              ...
              <h2 className="ml-2 text-lg text-gray-800 font-medium">Add Terms & Conditions</h2>
            </div>
